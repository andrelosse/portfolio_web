...
const Projects = () => (
    <section id="projects" className={`${stylesjs.paddingY} ${stylesjs.flexCenter} flex-col relative`}>
        ...
        <div className="showoption">
            ...
            <label id='showmore' for='ch' className='flex justify-center items-center cursor-pointer font-poppins font-bold leading-[23px] text-[17px] bg-blue-gradient rounded-3xl showmargin'></label>
